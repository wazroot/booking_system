...
def register_resources(app):
    ...
    api.add_resource(ReservationResource, '/reservations/<int:reservation_id>')  # to get a specific reservation by id and updating
    api.add_resource(ReservationUserResource, '/reservations/user/<int:user_id>')  # to get all reservations with a specific user id.
    api.add_resource(ReservationSpaceResource, '/reservations/space/<int:space_id>')  # to get all reservations with a specific space_id.
